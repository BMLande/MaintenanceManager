...
body class = "hold-transition skin-blue sidebar-mini" >
    ...
    <
    partial src = "partials/sidebar.html" > < /partial>
...
data - toggle = "btn-toggle" >
    <
    button type = "button"
class = "btn btn-default btn-sm active" > < i class = "fa fa-square text-green" > < /i> <
    /button> <
    button type = "button"
class = "btn btn-default btn-sm" > < i class = "fa fa-square text-red" > < /i></button >
    <
    /div> <
    /div> <
    /div> <
...
value = "" >
    ...
    <
    button type = "button"
class = "btn btn-default pull-right" > < i class = "fa fa-plus" > < /i> Add item</button >
    <
    /div> <
    /div>
    <!-- /.box -->
...
partial src = "partials/footer.html" / >
    ...
    <
    li > < a href = "#control-sidebar-home-tab"
